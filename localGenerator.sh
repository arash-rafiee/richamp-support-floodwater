...
# python generateGraphs.py --stations NAPATREE_DEEPLINE_STATIONS.json --meshExists true --tempDir /scratch3/workspace/pranav_sai_uri_edu-runup/temp/ --backgroundChoice NAPATREE --mesh /scratch3/workspace/pranav_sai_uri_edu-runup/Dec172023RunupRun/forecast_RI_track/fort.14
