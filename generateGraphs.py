...
NEW_LONDON_METRO_MAP = "NewLondonMetro.png"
NEW_LONDON_METRO_OUTLINE_MAP = "NewLondonMetroOutline.png"
NEW_LONDON_METRO_AXIS = [-72.13149841308592, -72.02850158691405, 41.383650725307994, 41.306326318981746]
...
LITTLE_NARRAGANSETT_BAY_AXIS = [-71.89574920654297, -71.84425079345704, 41.339335652731975, 41.3006586089844]
...
NAPATREE_BEACH_MAP = "NapatreeBeach.png"
...
#         backgroundAxis = AMERICA_AXIS
        ...
        backgroundAxis = NEW_LONDON_AXIS
    elif(backgroundChoice == "NEW_LONDON_METRO"):
        backgroundMap = NEW_LONDON_METRO_MAP
        backgroundAxis = NEW_LONDON_METRO_AXIS
    elif(backgroundChoice == "NEW_LONDON_METRO_OUTLINE"):
        backgroundMap = NEW_LONDON_METRO_OUTLINE_MAP
        backgroundAxis = NEW_LONDON_METRO_AXIS
        ...
        backgroundAxis = ATLANTIC_BEACH_PARK_AXIS
    elif(backgroundChoice == "NAPATREE_BEACH"):
        backgroundMap = NAPATREE_BEACH_MAP
...
#         waterStartDateObject = datetime.datetime(year=2023, month=12, day=15, hour=0, tzinfo=datetime.timezone.utc)
#         waterEndDateObject = datetime.datetime(year=2023, month=12, day=20, hour=0, tzinfo=datetime.timezone.utc)
