...
DEEPLINE_DISTANCES_1 = [
    {"distance": 600, "depth": "7m1"},
    {"distance": 625, "depth": "7m2"},
    {"distance": 650, "depth": "7m3"},   # Napatree1 (runup_id: 10)
    {"distance": 1500, "depth": "15m"},
    {"distance": 2320, "depth": "20m"}
]
DEEPLINE_DISTANCES_2 = [
    {"distance": 350, "depth": "7m1"},
    {"distance": 400, "depth": "7m2"},
    {"distance": 450, "depth": "7m3"},   # Napatree2 (runup_id: 20)
    {"distance": 1400, "depth": "15m"},
    {"distance": 1750, "depth": "20m"}
]
DEEPLINE_DISTANCES_3 = [
    {"distance": 125, "depth": "7m1"},
    {"distance": 150, "depth": "7m2"},
    {"distance": 175, "depth": "7m3"},  # Napatree3 (runup_id: 30)
...
DEEPLINE_DISTANCES_4 = [
    {"distance": 125, "depth": "7m1"},
    {"distance": 150, "depth": "7m2"},
    {"distance": 175, "depth": "7m3"},   # Napatree4 (runup_id: 40)
    {"distance": 1200, "depth": "15m"},
    {"distance": 1750, "depth": "20m"}
]
DEEPLINE_DISTANCES_5 = [
    {"distance": 100, "depth": "7m1"},
    {"distance": 125, "depth": "7m2"},
    {"distance": 150, "depth": "7m3"},   # Napatree5 (runup_id: 50)
